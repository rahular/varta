...
MODEL_DIR=models/mbert_hi_run3
...
for lg in as bh bn en gu hi kn ml mr ne or pa ta te ur; do  # en
	python run_sum.py   --model_name_or_path=${MODEL_DIR}/checkpoint-23500 \
                        --text_column=text \
